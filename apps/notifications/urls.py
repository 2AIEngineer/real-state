...
urlpatterns = [
    ...
    path(
        "notifications/unread-count/", UnreadCountView.as_view(), name="notification-unread-count"
    ),
    ...
    path("notifications/push-tokens/", PushTokenView.as_view(), name="push-token-register"),
    path(
