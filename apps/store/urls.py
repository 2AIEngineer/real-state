...
urlpatterns = [
    ...
    path(
        "store/products/<int:product_id>/", views.ProductDetailView.as_view(), name="product-detail"
    ),
    path(
    ...
    path("store/orders/<int:order_id>/", views.OrderDetailView.as_view(), name="order-detail"),
    path(
    ...
    path(
        "store/orders/<int:order_id>/cancel/", views.OrderCancelView.as_view(), name="order-cancel"
    ),
]
